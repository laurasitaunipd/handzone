---
title: "The unhealthy causal salad: \\newline causal inference, DAGs and propensity scores"
format: 
  beamer
editor: visual
header-includes:
...
![](Studio%20CAH.png){fig-align="left" width="450"} <!-- # DAGitty 1 -->
...
2.  con **aggiustamento additivo** delle covariate + tramite **propensity score** (ottenuta applicando il metodo IPTW)
