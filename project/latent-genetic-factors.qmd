...
How can we uncover **latent factors** capturing **shared genetic risk** across disorders?

- Existing approach (Grotzinger et al., 2022): **Genomic Structural Equation Modeling (genomic SEM)**
...
<img src="images/image1.png" style="display: block; margin-left: auto; margin-right: auto; width: 60%; max-width: 1000px;">
...
<p style="font-size:60%; text-align:left">
- **Four factors** underlie genetic correlations among the disorders
</p>
...
NMF implemented through two algorithms in the R package `causalLFO`
...
impute_and_stabilize_fit <- impute_and_stabilize(M, 
                                                 Tr, 
                                                 rank = 4,
                                                 reference_P = true_P)

impute_and_stabilize_fit$Chat[, 1:6] # first 6 columns
...
<span style="color:#900000;">red line</span> = perfect correspondence between true and estimated values of individual contributions
</center>

# Analytical Framework

- Use the same dataset as Grotzinger et al. (2022), UK Biobank  

- Estimate **four latent factors** ($L_1, \dots, L_4$) using NMF via the Impute and Stabilize algorithm  

- Compare the identified $L_k$ with those obtained through genomic SEM
...
# Materials 
All materials are available on GitHub in the `project` folder of the repository <a href="https://github.com/laurasitaunipd/handzone.git" target="_blank">laurasitaunipd/handzone</a>
